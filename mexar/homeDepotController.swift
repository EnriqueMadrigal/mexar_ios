...
class homeDepotController: UIViewController , UITableViewDelegate,  UITableViewDataSource{
  ...
  //  @IBOutlet weak var tableView_Distribuidores: UITableView!
    ...
    */
    ...
    func getDistribuidores()
    {
        ...
        if let bundlePath = Bundle.main.url(forResource: "homedepot", withExtension: "json"){
            do {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell
    {
        ...
        if (tableView == self.tableView_Distribuidores){
            ...
            cell.label_direccion.text = curDistribuidor.getAddress()
